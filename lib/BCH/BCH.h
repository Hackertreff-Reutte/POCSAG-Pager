...
class BCH{
    ...
    private:
        ...
        ArrayList<unsigned long> errorCorrectionRecursion(unsigned long code, int codeLength, unsigned long generator, int depth, bool enableParityCheck, bool parity);
